...
CREATE TABLE `notasfiscais` (
    ...
    `n_numero` VARCHAR(44) NOT NULL,
    `n_data` TIMESTAMP(3) NOT NULL,
    `n_chave` VARCHAR(100) NOT NULL,
    `n_xml` LONGTEXT NOT NULL,
    `n_emissor` VARCHAR(50) NOT NULL,
...
CREATE TABLE `movimentos` (
    ...
    `m_data` TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `m_loteid` INTEGER NOT NULL,
    `m_idnota` INTEGER NOT NULL,
    `m_responsavelid` INTEGER NOT NULL,
    `m_mensagem` VARCHAR(255) NULL,
